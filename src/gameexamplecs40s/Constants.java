...
public class Constants 
{
    ...
    public final static String GAME_OVER_LOSE_SOUND         = "/media/pacman_death.wav";
    public final static String GAME_OVER_WIN_SOUND          = "/media/pacman_eatghost.wav";
    public final static String EAT_DOT_SOUND                = "/media/pacman_chomp.wav";
    public final static String SPRITE_SHEET                 = "/media/pacmanSpriteSheet.png";
